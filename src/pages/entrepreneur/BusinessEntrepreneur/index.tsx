      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col gap-6 mobile:gap-4 py-16 mobile:py-8 px-[6.25rem]">
          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">Sobre o negócio</span>
            <p className="font-inter text-sm text-justify">Estamos a começar a temporada com a nossa mistura de Solstício de Verão. Uma celebração de longos dias,
              tempo quente e um pouco de R&R extra. É suculento, doce e delicioso quente ou gelado.
              Obtemos e assados este blend para produzir um espectro de sabores que entrega uma experiência animada
              e refinada no copo.</p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">Telefone</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">E-mail</span>
            <p className="font-inter text-sm text-justify">mail@example.com</p>
          </div>

          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">Website</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">Horários de funcionamento</span>
            <p className="font-inter text-sm text-justify">Segunda à  Sexta: 07:00 - 17:00</p>
            <p className="font-inter text-sm text-justify">Sábado: 07:00 - 19:00</p>
            <p className="font-inter text-sm text-justify">Domingo: 07:00 - 21:00</p>
          </div>

          <div className="flex flex-col gap-1">
            <span className="font-inter font-medium text-base">Endereço</span>
            <p className="font-inter text-sm text-justify">Av. dos Estudantes, 107 - Paraíso, Ibiporã - PR, 86200-000</p>
          </div>

          <span className="py-3 border-b border-black font-inter font-medium text-base">Imagens</span>
